...
```{r d-by-cdi-category-fig, fig.width = 10, fig.height = 10, fig.cap = "The relative positioning of the items by semantic category (colored) plotted in the context of the full item pool (grey): (A) English, (B) Polish.", fig.pos = '!h', include = T}
...
ggplot(aes(d, a1))  + 
  geom_point(data = items_cat_en %>%
               select(-category), aes(x = d, y = a1), color = 'grey', size = 0.4, alpha = .5) +
...
fig1 <- ggarrange(fig1a, fig1b, ncol = 1, nrow = 2)
fig1
```
