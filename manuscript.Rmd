...
For a CAT-CDI to be effective in these contexts – whether for screening, diagnosis, or broader research purposes – it should meet the following criteria:
...
In the following section we will explore the two CAT-CDI's performance on each of those criteria. The English data presented here were also included in a brief validation report by Kachergis et al. (2022). In the present paper, however, we examine these metrics in greater detail and place them in relation to the validation results from the Polish CAT-CDI.
