...
prod_s %>%
  ...
  geom_segment(aes(x = fullTheta, y = fullTheta_SE, xend = catTheta, yend = catTheta_SE, group = subject_id), color = "black") +
     ylab("SE") + xlab("Theta")
...
by_child_pl %>%
  ...
  geom_segment(aes(x = full_theta, y = full_theta_se, xend = cat_theta, yend = cat_theta_se, group = id), color = "black") +
     ylab("SE") + xlab("Theta")
