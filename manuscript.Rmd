...
In the following section we will explore the two CAT-CDI's performance on each of those criteria. The English data presented here were also included in a brief validation section in Kachergis et al. (2022). In the present paper, however, we examine these metrics in greater detail and place them in relation to the validation results from the Polish CAT-CDI.
